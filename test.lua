-- GOTHBEACH ULTIMATE v4.1 [FINAL RAGE]
...
-- ============================================================
local Window = KavoLambo.CreateLib("GOTHBEACH ULTIMATE v4.1 [FINAL RAGE]")
...
CombatSection:NewToggle("Aimbot (мгновенный)", "", function(state)
    aimbotEnabled = state
end)
...
print("GOTHBEACH ULTIMATE v4.1 [FINAL RAGE] загружен!")
