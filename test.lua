-- УДАЛЕНИЕ СТАРЫХ КРИВЫХ КНОПОК ИЗ ПАМЯТИ ТЕЛЕФОНА
if game.Players.LocalPlayer.PlayerGui:FindFirstChild("LamboUILib") then game.Players.LocalPlayer.PlayerGui.LamboUILib:Destroy() end
...
if game.Players.LocalPlayer.PlayerGui:FindFirstChild("KavoUILib") then game.Players.LocalPlayer.PlayerGui.KavoUILib:Destroy() end
...
function KavoLambo.CreateLib(titleText)
    ...
    function libObj:NewTab(tabName)
        ...
        local BtnCrn = Instance.new("UICorner", TabBtn)
        BtnCrn.CornerRadius = UDim.new(0, 5)
        ...
        function pageObj:NewSection()
            ...
            function secObj:NewToggle(text, desc, callback)
                ...
                local TglCrn = Instance.new("UICorner", ToggleBg)
                ...
                local CircleCrn = Instance.new("UICorner", Circle)
    ...
    for _, plr in pairs(game.Players:GetPlayers()) do
        if plr ~= player and plr.Character and plr.Character:FindFirstChild("Head") then
            ...
            if not head:FindFirstChild("BillboardGui") then
                ...
                bill.Size = UDim2.new(0, 140, 0, 25)
