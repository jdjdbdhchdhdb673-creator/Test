-- =========================================================
-- PREMIUM LAMBORGHINI UI ENGINE (FLUID & NEON DESIGNS)
-- =========================================================
local KavoLambo = {}
...
function KavoLambo.CreateLib(titleText)
    ...
    Container.Position = UDim2.new(0, 142, 0, 40)
    ...
    function libObj:NewTab(tabName)
        ...
        function pageObj:NewSection()
            ...
            function secObj:NewToggle(text, desc, callback)
                ...
                TglFrame.Size = UDim2.new(1, -5, 0, 34)
...
-- =========================================================
-- НАСТРОЙКА И СБОРКА ИНТЕРФЕЙСА С КРАСНЫМИ КНОПКАМИ
-- =========================================================
