-- GOTHBEACH ULTIMATE v3.0 (FULL RAGE)
...
function KavoLambo.CreateLib(titleText)
    ...
    Main.Active = true
    Main.Draggable = true  -- <-- КНОПКУ МОЖНО ПЕРЕТАСКИВАТЬ
...
-- ============================================================
local Window = KavoLambo.CreateLib("GOTHBEACH ULTIMATE v3.0 [RAGE]")
...
CombatSection:NewButton("Навестись на ближайшего (разово)", "", function()
...
-- ============================================================
-- ВИЗУАЛЫ (РАБОЧИЙ ЦВЕТ НЕБА + ПОДСВЕТКА)
-- ============================================================
...
-- Обновление подсветки при появлении/исчезновении игроков
...
print("GOTHBEACH ULTIMATE v3.0 [RAGE] загружен! Меню перетаскивается.")
