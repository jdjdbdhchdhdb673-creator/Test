-- ГИД ХАБ v14.0 (ТОЧНАЯ КОПИЯ MM2 STYLE)
...
-- ===== ИНТЕРФЕЙС (ТОЧНАЯ КОПИЯ) =====
local gui = Instance.new("ScreenGui")
gui.Name = "HydHub"
gui.Parent = CoreGui
gui.ResetOnSpawn = false

-- Главное окно (как на скрине)
...
local tabs = {"Main", "Farm", "Teleport", "Visuals", "Sets"}
local currentTab = 1
local tabButtons = {}
...
local function CreateSlider(text, yPos, defaultVal)
    ...
    frame.Size = UDim2.new(0.85, 0, 0, 32)
...
local function UpdateContent()
    ...
    elseif currentTab == 2 then
        ...
        y = y + 0.12
        CreateItem("📊 Статистика", y, function() print("Статистика") end)
...
-- Нижний колонтитул (как на скрине)
...
print("✅ GID_HUB v14.0 (Точная копия MM2) загружен!")
